 ...
 */
export declare enum PriceFeedTimeInterval {
    FIFTEEN_MINUTES = 900,
    ONE_HOUR = 3600,
    ONE_DAY = 86400
}
...
export declare class Prices {
    ...
    getFeedWithInterval(token: string, currency: string, interval: PriceFeedTimeInterval, size?: number, next?: string): Promise<ApiPagedResponse<PriceFeedInterval>>;
    /**
