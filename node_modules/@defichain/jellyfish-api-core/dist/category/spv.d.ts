...
export declare const HTLC_MINIMUM_BLOCK_COUNT = 9;
/**
...
export declare class Spv {
     ...
     */
    listReceivedByAddress(minConfirmation?: number, address?: string): Promise<ReceivedByAddressInfo[]>;
    /**
     ...
     */
    sendToAddress(address: string, amount: BigNumber, options?: SpvDefaultOptions): Promise<SendMessageResult>;
    /**
     ...
     * @return {Promise<SendMessageResult>}
     */
    refundHtlc(scriptAddress: string, destinationAddress: string, options?: SpvDefaultOptions): Promise<SendMessageResult>;
    /**
     ...
     */
    refundHtlcAll(destinationAddress: string, options?: SpvDefaultOptions): Promise<string[]>;
    /**
     ...
     */
    createAnchor(createAnchorInputs: CreateAnchorInput[], rewardAddress: string, options?: CreateAnchorOptions): Promise<CreateAnchorResult>;
    /**
     * List anchors
     *
     ...
     * @return {Promise<ListAnchorsResult[]>}
     */
    listAnchors(options?: ListAnchorsOptions): Promise<ListAnchorsResult[]>;
    /**
