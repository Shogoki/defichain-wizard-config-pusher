...
class Spv {
     ...
     */
    refundHtlcAll(destinationAddress, options = { feeRate: new bignumber_js_1.default('10000') }) {
        return __awaiter(this, void 0, void 0, function* () {
            /**
             ...
             */
            return yield this.client.call('spv_refundhtlcall', [destinationAddress, options.feeRate], 'number');
        });
    }
    /**
